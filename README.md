...
1. Add https://ji33my.github.io/Bouncing-Pokemon-Overlay/Bouncing-Pokemon.html as a **Browser Source** in OBS and set the size to the same resolution as your monitor/stream.
